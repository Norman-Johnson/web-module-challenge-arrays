...
let newArr = [...arr, lastFlavor];
newArr.pop(lastFlavor);
console.log(newArr);
return newArr;
}
console.log(removeLastFlavor, 'Vanilla Burnt Almond')
...
console.log(getFlavorByIndex, 'Coffee')
...
let newArr = originalFlavor.splice(17,3)
}
console.log(removeFlavorByName) 
// console.log(removeLastFlavor(originalFlavors, 'Lemon'))
